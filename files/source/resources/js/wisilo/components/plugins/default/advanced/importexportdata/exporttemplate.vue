                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><router-link :to="'/' + main_folder + '/wisiloadvied_export'">{{ $t("Export") }}</router-link></li>
    ...
    export default {
        ...
        methods: {
            ...
            loadPageVariables: function () {
                ...
                axios.get(WisiloHelper.getAPIURL("wisilo/get_page_variables/proje"))
                    .then(({ data }) => {
                        ...
                        WisiloHelper.initializePermissions(self.page.variables, false);
                        self.page.authorization = WisiloHelper.hasUserADVIEDAuthorized(self.page.variables, "exporttemplate");
                        self.processLoadQueue();
                    });
            ...
            load_parameter_list: function () {
                ...
                axios.get(WisiloHelper.getAPIURL("wisiloadvied/get_parameterlist/" + self.id))
                    .then(({ data }) => {
                    ...
                    .then(({ data }) => {
                        ...
                        if (!self.delete_form.has_error) {
                            Vue.swal.fire({
                                ...
                                timerProgressBar: true,
                                onClose: () => {
                                    self.$router.push('/' + self.main_folder + '/wisiloadvied_export');
                                }                            
                            }); 
                        } else {
                            Vue.swal.fire({
            ...
            saveParameter: function () {
                ...
                self.$Progress.start();
                self.ParameterForm.post(WisiloHelper.getAPIURL("wisiloadvied/post_parameter"))
                    .then(({ data }) => {
                        self.$Progress.finish();
                        self.page.has_post_error = data.has_error;
                        self.page.has_server_error = false;
            ...
            submitDeleteParameterForm: function () {
                var self = this;
                self.$Progress.start();
                self.formParameterDelete.post(WisiloHelper.getAPIURL("wisiloadvied/delete_parameter"))
                    .then(({ data }) => {
                        self.$Progress.finish();
                        self.delete_form.has_error = data.has_error;
                        self.delete_form.error_msg = data.error_msg;
