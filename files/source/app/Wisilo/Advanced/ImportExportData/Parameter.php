...
class Parameter extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'wisiloadviedparametertable';
    ...
    static function getTableName() {
		return 'wisiloadviedparametertable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectWisilo = new Wisilo();
		$query = $objectWisilo->getQuery($query, 'Parameter', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
