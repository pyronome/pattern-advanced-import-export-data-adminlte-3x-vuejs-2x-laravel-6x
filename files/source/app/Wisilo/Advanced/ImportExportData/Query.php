...
class Query extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'wisiloadviedquerytable';
	...
	static function getTableName() {
		return 'wisiloadviedquerytable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectWisilo = new Wisilo();
		$query = $objectWisilo->getQuery($query, 'Query', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
