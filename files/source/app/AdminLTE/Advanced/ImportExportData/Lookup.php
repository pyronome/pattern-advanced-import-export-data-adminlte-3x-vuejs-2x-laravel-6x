...
class Lookup extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'adminlteadviedlookuptable';
	...
	static function getTableName() {
		return 'adminlteadviedlookuptable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectAdminLTE = new AdminLTE();
		$query = $objectAdminLTE->getQuery($query, 'Lookup', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
