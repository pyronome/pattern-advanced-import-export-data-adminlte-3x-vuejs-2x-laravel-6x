...
class Template extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'adminlteadviedtemplatetable';
	...
	static function getTableName() {
		return 'adminlteadviedtemplatetable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectAdminLTE = new AdminLTE();
		$query = $objectAdminLTE->getQuery($query, 'Template', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
