...
class Action extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'adminlteadviedactiontable';
	...
	static function getTableName() {
		return 'adminlteadviedactiontable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectAdminLTE = new AdminLTE();
		$query = $objectAdminLTE->getQuery($query, 'Action', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
