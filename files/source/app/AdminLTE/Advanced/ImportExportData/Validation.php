...
class Validation extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'adminlteadviedvalidationtable';
	...
	static function getTableName() {
		return 'adminlteadviedvalidationtable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectAdminLTE = new AdminLTE();
		$query = $objectAdminLTE->getQuery($query, 'Validation', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
