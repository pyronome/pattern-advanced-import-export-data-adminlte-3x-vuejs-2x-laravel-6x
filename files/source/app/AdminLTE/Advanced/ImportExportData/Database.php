...
class Database extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'adminlteadvieddatabasetable';
	...
	static function getTableName() {
		return 'adminlteadvieddatabasetable';
	}

	public function scopeDefaultQuery($query, $search_text, $sort_variable, $sort_direction) {
		$objectAdminLTE = new AdminLTE();
		$query = $objectAdminLTE->getQuery($query, 'Database', $this::$property_list, $search_text, $sort_variable, $sort_direction);
		return $query;
	}
